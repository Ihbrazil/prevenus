  ...
  return (
    <main>
      ...
      <section className={estilos.secao_nossos_sabores}>
            ...
            <div className={estilos.container_texto}>
                <h2>Sentinela</h2>
                <span>Sentinela, também, é um sistema que auxilia na prevenção às doenças ocupacionais em informática, ele complementa o objetivo do Preven. Durante a atividade são exibidas imagens, que alerta o usuário sobre a velocidade de digitação praticada:
                  <ul type="none">
                ...
                <p>
                  <Link
                    ...
                    target="_blank"
                    >Download disponível para Windows: Sentinela
                  </Link>
                </p>
              </div>
        </section>
